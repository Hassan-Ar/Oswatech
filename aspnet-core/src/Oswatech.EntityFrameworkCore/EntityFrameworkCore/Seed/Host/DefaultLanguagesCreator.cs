...
namespace Oswatech.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly OswatechDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = OswatechConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OswatechDbContext context)
        {
            _context = context;
        }
