...
{
    public abstract class OswatechWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OswatechWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OswatechWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OswatechDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OswatechDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OswatechDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OswatechDbContext, Task<T>> func)
        {
            T result;
